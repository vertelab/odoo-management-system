...
class Iso22000Objective(models.Model):
    _name = "iso22000.objective"
    _description = "Food Safety Objective"
    ...
    kpi_description = fields.Char(
        ...
        help="How this objective will be measured",
    )
    ...
    iso22000_clause_ids = fields.Many2many(
        ...
        help="Linked to ISO 22000:2018 clauses, typically 6.2",
    )
