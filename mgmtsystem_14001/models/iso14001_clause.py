...
class Iso14001Clause(models.Model):
    _name = "iso14001.clause"
    _description = "ISO 14001:2026 Clause"
    ...
    parent_id = fields.Many2one(
        "iso14001.clause", "Parent Clause", index=True, ondelete="cascade"
    )
    child_ids = fields.One2many("iso14001.clause", "parent_id", "Child Clauses")
